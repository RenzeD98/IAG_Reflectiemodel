        ...
        <div class="reflection-model-open" id="reflection-model-open">
          <div class="container reflectiemodel">
            <div class="reflectioncontainer">
                <div class="topleft">
                    <a class="page-loader" link="/reflectionmodel/8/radar"><img src="{{ URL::asset('images/custom.png') }}" alt="" class="custom"></a>
                    <a class="page-loader" link="/reflectionmodel/7/radar"><img src="{{ URL::asset('images/transparent.png') }}" alt="" class="transparant"></a>
                </div>
                <div class="topright">
                    <a class="page-loader" link="/reflectionmodel/1/radar"><img src="{{ URL::asset('images/theory.png') }}" alt="" class="theorie"></a>
                    <a class="page-loader" link="/reflectionmodel/3/radar"><img src="{{ URL::asset('images/model.png') }}" alt="" class="model"></a>
                </div>
                <div class="bottomleft">
                    <a class="page-loader" link="/reflectionmodel/6/radar"><img src="{{ URL::asset('images/feedback.png') }}" alt="" class="feedback"></a>
                    <a class="page-loader" link="/reflectionmodel/5/radar"><img src="{{ URL::asset('images/methodology.png') }}" alt="" class="methodiek"></a>
                </div>
                <div class="bottomright">
                    <a class="page-loader" link="/reflectionmodel/2/radar"><img src="{{ URL::asset('images/focus.png') }}" alt="" class="gerichtheid"></a>
                    <a class="page-loader" link="/reflectionmodel/4/radar"><img src="{{ URL::asset('images/strategy.png') }}" alt="" class="strategie"></a>
                </div>
            </div>
            <hr>
        </div>
